...
describe "String#eql?" do |it| 
  it.behaves_like(:string_equal_value, :eql?)
end

describe "String#eql? when given a non-String" do |it| 
  it.returns "false" do
  ...
  it.does_not "try to call #to_str on the given argument" do

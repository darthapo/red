...
describe "Integer#chr" do |it| 
  it.returns "a string containing the ASCII character represented by self" do
    [82.chr, 117.chr, 98.chr, 105.chr, 110.chr, 105.chr, 117.chr, 115.chr, 
     32.chr, 
     114.chr, 111.chr, 99.chr, 107.chr, 115.chr].should_equal()
  ...
  it.raises " a RangeError if self is out of the ASCII character range" do
    lambda { -1.chr }.should_raise(RangeError)
    lambda { -300.chr }.should_raise(RangeError)
    lambda { (-bignum_value).chr }.should_raise(RangeError)

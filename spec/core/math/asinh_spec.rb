...
describe "Math.asinh" do |it| 
  it.returns "a float" do
    Math.asinh(1.5).class.should_equal(Float)
  end
  ...
  it.returns "the inverse hyperbolic sin of the argument" do
    ...
    Math.asinh(0.0).should_equal(0.0)
    Math.asinh(-0.0).should_equal(-0.0)
    Math.asinh(1.05367e-08).should_be_close(1.05367e-08, TOLERANCE)
    Math.asinh(-1.05367e-08).should_be_close(-1.05367e-08, TOLERANCE)
    # Default tolerance does not scale right for these...
    #Math.asinh(94906265.62).should_be_close(19.0615, TOLERANCE)
    #Math.asinh(-94906265.62).should_be_close(-19.0615, TOLERANCE)
  end
  
  it.raises " an ArgumentError if the argument cannot be coerced with Float()" do    
    lambda { Math.asinh("test") }.should_raise(ArgumentError)
  end
  
  it.raises " a TypeError if the argument is nil" do
    lambda { Math.asinh(nil) }.should_raise(TypeError)
  end

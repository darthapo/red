...
describe "Proc.new with an associated block" do |it| 
  it.returns "a proc that represents the block" do
    Proc.new { }.call.should_equal(nil)
    Proc.new { "hello" }.call.should_equal("hello")
  end
  ...
  it.raises " a LocalJumpError when context of the block no longer exists" do
    ...
    lambda { res.call }.should_raise(LocalJumpError)
  end
  ...
  it.returns "from within enclosing method when 'return' is used in the block" do
    ...
    some_method.should_equal(:proc_return_value)
  end

end

describe "Proc.new without a block" do |it| 
  it.raises " an ArgumentError" do
    lambda { Proc.new }.should_raise(ArgumentError)
  end
  ...
  it.returns "a new Proc instance from the block passed to the containing method" do
    ProcSpecs.new_proc_in_method { "hello" }.call.should_equal("hello")
  end

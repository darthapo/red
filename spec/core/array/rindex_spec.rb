...
describe "Array#rindex" do |it| 
  ...
  it.does_not "fail when removing elements from block" do
    ...
    ary.rindex(0).should_equal(0)
  end

  it.can "properly handles recursive arrays" do
    empty = ArraySpecs.empty_recursive_array
    empty.rindex(empty).should_equal(0)
    empty.rindex(1).should_be_nil

    array = ArraySpecs.recursive_array
    array.rindex(1).should_equal(0)
    array.rindex(array).should_equal(7)
  end
end
